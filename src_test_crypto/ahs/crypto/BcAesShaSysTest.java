...
public class BcAesShaSysTest extends TestCase {
	...
	private final byte[]	$c1	= Strings.toBytes("oh god I'm covered in bees");
	private final Ks	$ks1	= new Ks.Basic(new byte[] { 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F });
	private final Ks	$ks2	= new Ks.Basic(new byte[] { 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C, 0x2D, 0x2E, 0x2F });
	private final Ks	$ks11	= new Ks.Basic(new byte[] { 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F });		// same as ks1 but not peq
	private final Ks	$ksws	= new Ks.Basic(new byte[] { 0x33, 0x29, 0x58, 0x76 });		// weird size
	private final Kc	$kc1	= new Kc(new byte[] { 0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xA, 0xB, 0xC, 0xD, 0xE, 0xF });
	private final Kc	$kc0	= new Kc(new byte[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 });
	private final Kc	$kcws	= new Kc(new byte[] { 0x0, 0x0, 0x0 });		// weird size
