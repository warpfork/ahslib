...
public class RSA1024 implements KeySystemAsymRsa {
	...
	/** {@inheritDoc} */
	public Tup2<KeyRsaPub,KeyRsaPrv> generateKeys() {
		try {
			...
			return new Tup2<KeyRsaPub,KeyRsaPrv>(new KeyRsaPub((RSAPublicKey)$kp.getPublic()), new KeyRsaPrv((RSAPrivateKey)$kp.getPrivate()));
		} catch (NoSuchAlgorithmException $e) {
