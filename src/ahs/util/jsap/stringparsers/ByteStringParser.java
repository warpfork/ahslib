...
/**
 * A {@link ahs.util.jsap.StringParser} for parsing Bytes.  The parse() method delegates the actual
...
public class ByteStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#BYTE_PARSER}.
	 *  
     ...
     * @deprecated Use {@link #getParser()} or, even better, {@link ahs.util.jsap.JSAP#BYTE_PARSER}.
     */
