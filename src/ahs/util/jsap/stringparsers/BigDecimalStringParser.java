...
/**
 * A {@link ahs.util.jsap.StringParser} for parsing BigDecimals.  The parse() method delegates the
 * actual
...
public class BigDecimalStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#BIGDECIMAL_PARSER}.
	 *  
     ...
     * @deprecated Use {@link #getParser()} or, even better, {@link ahs.util.jsap.JSAP#BIGDECIMAL_PARSER}.
     */
