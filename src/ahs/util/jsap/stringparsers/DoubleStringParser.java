...
/**
 * A {@link ahs.util.jsap.StringParser} for parsing Doubles.  The parse() method delegates the actual
...
public class DoubleStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#DOUBLE_PARSER}.
	 *  
     ...
     * @deprecated Use {@link #getParser()} or, even better, {@link ahs.util.jsap.JSAP#DOUBLE_PARSER}.
     */
