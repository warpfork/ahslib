...
/**
 * A {@link ahs.util.jsap.StringParser} for parsing Integers.  The parse() method delegates the actual
...
public class IntegerStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#INTEGER_PARSER}.
	 *  
     ...
     * @deprecated Use {@link #getParser()} or, even better, {@link ahs.util.jsap.JSAP#INTEGER_PARSER}.
     */
