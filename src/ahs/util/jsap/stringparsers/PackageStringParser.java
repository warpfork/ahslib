...
/**
 * A {@link ahs.util.jsap.StringParser} for parsing Packages.  The parse() method delegates the actual
...
public class PackageStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#PACKAGE_PARSER}.
	 *  
     ...
     * @deprecated Use {@link #getParser()} or, even better, {@link ahs.util.jsap.JSAP#PACKAGE_PARSER}.
     */
