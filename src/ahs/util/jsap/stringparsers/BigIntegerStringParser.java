...
/**
 * A {@link ahs.util.jsap.StringParser} for parsing BigIntegers.  The parse() method delegates the
 * actual
...
public class BigIntegerStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#BIGINTEGER_PARSER}.
	 *  
     ...
     * @deprecated Use {@link #getParser()} or, even better, {@link ahs.util.jsap.JSAP#BIGINTEGER_PARSER}.
     */
