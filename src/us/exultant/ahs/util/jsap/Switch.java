...
import us.exultant.ahs.util.jsap.stringparsers.BooleanStringParser;

/**
 * A Switch is a parameter whose presence alone is significant; another 
 * commonly used term for a Switch is "Flag".
 * Switches use a {@link ahs.util.jsap.stringparsers.BooleanStringParser}
 ...
 * @see ahs.util.jsap.stringparsers.BooleanStringParser
 */
public class Switch extends Parameter implements Flagged {
	 ...
	 */
	protected List<Boolean> parse(String arg) throws ParseException {
