...
public class JSAPResult implements ExceptionMap {
     ...
     * @see ahs.util.jsap.ExceptionMap#addException(String,Exception)
     */
     ...
     * @see ahs.util.jsap.ExceptionMap#getException(String)
     */
     ...
     * @see ahs.util.jsap.ExceptionMap#getExceptionArray(String)
     */
