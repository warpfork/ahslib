...
/**
 * A {@link ahs.util.jsap.StringParser} for parsing Class objects.  The parse(arg) method calls
...
public class ClassStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#CLASS_PARSER}.
	 *  
     ...
     * @deprecated Use {@link #getParser()} or, even better, {@link ahs.util.jsap.JSAP#CLASS_PARSER}.
     */
