package us.exultant.ahs.scratch.crypto.jce.ibe;
 ...
 * @param <$KEYPRV>
 */
public interface KeySystemIbe<$KEYPUB extends KeyIbePub, $KEYPRV extends KeyIbePrv> extends KeySystem {
	public $KEYPRV generateKey($KEYPUB $ko);
