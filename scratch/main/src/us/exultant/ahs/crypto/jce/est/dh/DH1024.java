...
public class DH1024 implements KeySystemEstDh<KeyAes> {
	...
	/** {@inheritDoc} */
	public Pair<KeyDhPub,KeyDhPrv> generateKeys() {
		KeyPair $kp = $keyGen.genKeyPair();
		return new Pair<KeyDhPub,KeyDhPrv>(new KeyDhPub((DHPublicKey)$kp.getPublic()), new KeyDhPrv((DHPrivateKey)$kp.getPrivate()));
	}
