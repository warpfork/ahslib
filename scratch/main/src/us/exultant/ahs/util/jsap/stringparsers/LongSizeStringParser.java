...
/** A {@link ahs.util.jsap.StringParser} that lets the user specify sizes with an optional unit.
 * 
 * <P>This parser will parse its argument using {@link #parseSize(CharSequence)}.
 * 
 * @author Sebastiano Vigna
 * @see ahs.util.jsap.stringparsers.IntSizeStringParser
 */
...
public class LongSizeStringParser extends StringParser {
	 ...
	 * {@link ahs.util.jsap.JSAP#LONGSIZE_PARSER}.
	 *  
