package us.exultant.ahs.util.jsap;
...
import us.exultant.ahs.util.jsap.stringparsers.*;
//import us.exultant.ahs.util.jsap.xml.JSAPConfig;
 ...
 * 
 * <p>
 * A JSAP is responsible for converting an array of Strings, typically received from a
 * command line in the main class' main() method, into a collection of Objects that are
 * retrievable by a unique ID assigned by the developer.
 * </p>
 * 
 * <p>
 * Before a JSAP parses a command line, it is configured with the Switches,
 * FlaggedOptions, and UnflaggedOptions it will accept. As a result, the developer can
 * rest assured that if no Exceptions are thrown by the JSAP's parse() method, the entire
 * command line was parsed successfully.
 * </p>
 * 
 * <p>
 * For example, to parse a command line with the syntax "[--verbose] {-n|--number}
 * Mynumber", the following code could be used:
 * </p
 * .
 * 
 * <code><pre>
 ...
 * needs. See ahs.util.jsap.ant.JSAPAntTask for details.
 * </p>
 * <p>
...
public class JSAP {
	...
	/**
	 * List of all of this JSAP's AbstractParameters, in order of declaration.
	 */
	 ...
	 * 
	 * @see ahs.util.jsap.FlaggedOption
	 * @see ahs.util.jsap.UnflaggedOption
	 */
	 ...
	 */
	public static final char			DEFAULT_LISTSEPARATOR		= java.io.File.pathSeparatorChar;
	
	/**
	 * The default separator between parameters in generated help (a newline by
	 * default)
	 */
	 ...
	 * 
	 * @see ahs.util.jsap.UnflaggedOption#setGreedy(boolean)
	 */
	 ...
	 * 
	 * @see ahs.util.jsap.Parameter#setHelp(String)
	 */
	public static final String			NO_HELP				= null;
	
	/**
	 * The only instance of a
	 * {@link ahs.util.jsap.stringparsers.BigDecimalStringParser}.
	 */
	...
	/**
	 * The only instance of a
	 * {@link ahs.util.jsap.stringparsers.BigIntegerStringParser}.
	 */
	
	public static final BigIntegerStringParser	BIGINTEGER_PARSER		= BigIntegerStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.BooleanStringParser}.
	 */
	
	public static final BooleanStringParser		BOOLEAN_PARSER			= BooleanStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.ByteStringParser}.
	 */
	...
	/**
	 * The only instance of a
	 * {@link ahs.util.jsap.stringparsers.CharacterStringParser}.
	 */
	
	public static final CharacterStringParser	CHARACTER_PARSER		= CharacterStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.ClassStringParser}.
	 */
	...
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.ColorStringParser}.
	 */
	...
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.DoubleStringParser}.
	 */
	...
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.FloatStringParser}.
	 */
	...
	/**
	 * The only instance of a
	 * {@link ahs.util.jsap.stringparsers.InetAddressStringParser}.
	 */
	
	public static final InetAddressStringParser	INETADDRESS_PARSER		= InetAddressStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.IntegerStringParser}.
	 */
	
	public static final IntegerStringParser		INTEGER_PARSER			= IntegerStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.IntSizeStringParser}.
	 */
	
	public static final IntSizeStringParser		INTSIZE_PARSER			= IntSizeStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.LongSizeStringParser}
	 * .
	 */
	...
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.LongStringParser}.
	 */
	
	public static final LongStringParser		LONG_PARSER			= LongStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.PackageStringParser}.
	 */
	
	public static final PackageStringParser		PACKAGE_PARSER			= PackageStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.ShortStringParser}.
	 */
	
	public static final ShortStringParser		SHORT_PARSER			= ShortStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.StringStringParser}.
	 */
	
	public static final StringStringParser		STRING_PARSER			= StringStringParser.getParser();
	
	/**
	 * The only instance of a {@link ahs.util.jsap.stringparsers.URLStringParser}.
	 */
	...
	static {
		if (Boolean.valueOf(System.getProperty("ahs.util.jsap.usenbsp", "false")).booleanValue()) {
			SYNTAX_SPACECHAR = '\u00a0';
		}
	}
	
	/**
	 * Creates a new JSAP with an empty configuration. It must be configured with
	 * registerParameter() before its parse() methods may be called.
	 */
	public JSAP() {
		init();
	}
	...
	private void init() {
		paramsByID = new HashMap<String,Parameter>();
		paramsByShortFlag = new HashMap<Character,Parameter>();
		paramsByLongFlag = new HashMap<String,Parameter>();
		unflaggedOptions = new ArrayList<UnflaggedOption>();
		paramsByDeclarationOrder = new ArrayList<Parameter>();
		defaultSources = new ArrayList<DefaultSource>();
	}
	
	/**
	 * Sets the usage string manually, overriding the automatically- generated String.
	 * To remove the override, call setUsage(null).
	 * 
	 * @param usage
	 *                the manually-set usage string.
	 */
	 ...
	 * To remove the override, call setHelp(null).
	 * 
	 * @param help
	 *                the manually-set help string.
	 */
	 ...
	 * 
	 * @see #getHelp(int,String,boolean)
	 * @return the same as gethelp(80, "\n")
	 */
	public String getHelp() {
		return (getHelp(DEFAULT_SCREENWIDTH, DEFAULT_PARAM_HELP_SEPARATOR, true));
	}
	 ...
	 * @return the same as gethelp(80, "\n")
	 */
	public String getHelp(boolean hideUnflagged) {
		return (getHelp(DEFAULT_SCREENWIDTH, DEFAULT_PARAM_HELP_SEPARATOR, hideUnflagged));
	}
	 ...
	 */
	public String getHelp(int screenWidth, boolean hideUnflagged) {
		return (getHelp(screenWidth, DEFAULT_PARAM_HELP_SEPARATOR, hideUnflagged));
	}
	
	/**
	 * If the help text has been manually set, this method simply returns it, ignoring
	 * the screenWidth parameter. Otherwise, an automatically-formatted help message
	 * is returned, tailored to the specified screen width.
	 * 
	 * @param screenWidth
	 *                the screen width (in characters) for which the help text will be
	 *                formatted. If zero, help will not be line-wrapped.
	 * @param hideUnflagged
	 *                if true, no UnflaggedOption parameters will be output in the
	 *                help text.
	 * @return complete help text for this JSAP.
	 */
	public String getHelp(int screenWidth, String paramSeparator, boolean hideUnflagged) {
		String result = help;
		if (result == null) {
			...
			for (Iterator<Parameter> $itr = paramsByDeclarationOrder.iterator(); $itr.hasNext();) {
				Parameter param = $itr.next();
				if (hideUnflagged && param instanceof UnflaggedOption) continue; // hides main arguments from the automated help listing.
				...
				Iterator<String> helpInfo = ahs.util.Strings.wrapToList(param.getHelp() + defaultText, wrapWidth).iterator();
	...
	public String getColumnarHelp(int screenWidth) {
		String result = help;
		if (result == null) {
			StringBuffer buf = new StringBuffer();
			...
			//				                            DIR is `add', `remove', or `prefer'.
			//				                            `prefer' prefers ROOT_A, and is the default.
			//				  -q                        quiet. surpress change notifictions; report errors.
			//				  -t, --trial               trial run.  skips all actual changes.
			//				      --help                displays this help message and exits.
			//				      --selftest            makes a directory ./tmp/ and performs self tests.
			//
	...
	/**
	 * Returns an automatically generated usage description based upon this JSAP's
	 * current configuration.
	 * 
	 * @return an automatically generated usage description based upon this JSAP's
	 *         current configuration.
	 */
	...
	/**
	 * Returns an automatically generated usage description based upon this JSAP's
	 * current configuration. This returns exactly the same result as getUsage().
	 * 
	 * @return an automatically generated usage description based upon this JSAP's
	 *         current configuration.
	 */
	 ...
	 * parameters' IDs, and allowing the listing of IDs. This is probably only useful
	 * for developers creating their own DefaultSource classes.
	 * 
	 * @return an IDMap based upon this JSAP's current configuration.
	 */
	public IDMap getIDMap() {
		List<String> ids = new ArrayList<String>(paramsByDeclarationOrder.size());
		for (Iterator<Parameter> i = paramsByDeclarationOrder.iterator(); i.hasNext();)
			ids.add(i.next().getID());
		
		Map<String,String> byShortFlag = new HashMap<String,String>();
		for (Iterator<Character> i = paramsByShortFlag.keySet().iterator(); i.hasNext();) {
			Character c = i.next();
			byShortFlag.put(c.toString(), paramsByShortFlag.get(c).getID());
		}
		
		Map<String,String> byLongFlag = new HashMap<String,String>();
		for (Iterator<String> i = paramsByLongFlag.keySet().iterator(); i.hasNext();) {
			String s = i.next();
			byLongFlag.put(s, paramsByLongFlag.get(s).getID());
		}
	 ...
	 * specified ID. Depending upon what you intend to do with the result, it may be
	 * necessary to re-cast the result as a Switch, FlaggedOption, or UnflaggedOption
	 * as appropriate.
	 * 
	 * @param id
	 *                the ID of the requested Switch, FlaggedOption, or
	 *                UnflaggedOption.
	 * @return the requested Switch, FlaggedOption, or UnflaggedOption, or null if no
	 ...
	 * Depending upon what you intend to do with the result, it may be necessary to
	 * re-cast the result as a Switch or FlaggedOption as appropriate.
	 * 
	 * @param longFlag
	 *                the long flag of the requested Switch or FlaggedOption.
	 * @return the requested Switch or FlaggedOption, or null if no Flagged object
	 *         with the specified long flag is defined in this JSAP.
	 */
	 ...
	 * @return the requested Switch or FlaggedOption, or null if no Flagged object
	 *         with the specified short flag is defined in this JSAP.
	 */
	...
	/**
	 * Returns an Iterator over all UnflaggedOptions currently registered with this
	 * JSAP.
	 * 
	 * @return an Iterator over all UnflaggedOptions currently registered with this
	 *         JSAP.
	 ...
	 * @see ahs.util.jsap.DefaultSource
	 */
	...
	/**
	 * Removes the specified DefaultSource from this JSAP's DefaultSource chain. If
	 * this specified DefaultSource is not currently in this JSAP's DefaultSource
	 * chain, this method does nothing.
	 * 
	 * @param ds
	 *                the DefaultSource to remove from the DefaultSource chain.
	 */
	...
	/**
	 * Returns a Defaults object representing the default values defined within this
	 * JSAP's AbstractParameters themselves.
	 * 
	 * @return a Defaults object representing the default values defined within this
	 *         JSAP's AbstractParameters themselves.
	 */
	...
	/**
	 * Merges the specified Defaults objects, only copying Default values from the
	 * source to the destination if they are NOT currently defined in the destination.
	 * 
	 * @param dest
	 *                the destination Defaults object into which the source should be
	 *                merged.
	 * @param src
	 *                the source Defaults object.
	 */
	private void combineDefaults(Defaults dest, Defaults src) {
		if (src != null) {
			for (Iterator<String> i = src.idIterator(); i.hasNext();) {
				String paramID = i.next();
	 ...
	 * DefaultSource in the DefaultSource chain and the default values specified in
	 * the AbstractParameters themselves.
	 * 
	 * @param exceptionMap
	 ...
	 * @see ahs.util.jsap.DefaultSource#getDefaults(IDMap, ExceptionMap)
	 */
	...
	/**
	 * Registers the specified Parameter (i.e., Switch, FlaggedOption, or
	 * UnflaggedOption) with this JSAP.
	 * 
	 * <p>
	 * Registering an Parameter <b>locks</b> the parameter. Attempting to change its
	 * properties (ID, flags, etc.) while it is locked will result in a JSAPException.
	 * To unlock an Parameter, it must be unregistered from the JSAP.
	 * 
	 * @param param
	 *                the Parameter to register.
	 * @throws JSAPException
	 *                 if this Parameter cannot be added. Possible reasons include:
	 *                 <ul>
	 *                 <li>Another Parameter with the same ID has already been
	 *                 registered.</li> <li>You are attempting to register a Switch or
	 *                 FlaggedOption with neither a short nor long flag.</li> <li>You
	 *                 are attempting to register a Switch or FlaggedOption with a
	 *                 long or short flag that is already defined in this JSAP.</li>
	 *                 <li>You are attempting to register a second greedy
	 *                 UnflaggedOption</li>
	 *                 </ul>
	 */
	public void registerParameter(Parameter param) throws JSAPException {
		...
		if (paramsByID.containsKey(paramID)) { throw (new JSAPException("A parameter with ID '" + paramID + "' has already been registered.")); }
		
		if (param instanceof Flagged) {
			Flagged f = (Flagged) param;
			if ((f.getShortFlagCharacter() == null) && (f.getLongFlag() == null)) { throw (new JSAPException("FlaggedOption '" + paramID + "' has no flags defined.")); }
			if (paramsByShortFlag.containsKey(f.getShortFlagCharacter())) { throw (new JSAPException("A parameter with short flag '" + f.getShortFlag() + "' has already been registered.")); }
			if (paramsByLongFlag.containsKey(f.getLongFlag())) { throw (new JSAPException("A parameter with long flag '" + f.getLongFlag() + "' has already been registered.")); }
		} else {
			if ((unflaggedOptions.size() > 0) && ((unflaggedOptions.get(unflaggedOptions.size() - 1)).isGreedy())) { throw (new JSAPException("A greedy unflagged option has already been registered;" + " option '" + paramID + "' will never be reached.")); }
		}
	...
	/**
	 * Unregisters the specified Parameter (i.e., Switch, FlaggedOption, or
	 * UnflaggedOption) from this JSAP. Unregistering an Parameter also unlocks it,
	 * allowing changes to its properties (ID, flags, etc.).
	 * 
	 * @param param
	 *                the Parameter to unregister from this JSAP.
	 */
	...
	/**
	 * Parses the specified command line array. If no Exception is thrown, the entire
	 * command line has been parsed successfully, and its results have been
	 * successfully instantiated.
	 * 
	 * @param args
	 *                An array of command line arguments to parse. This array is
	 *                typically provided in the application's main class' main()
	 *                method.
	...
	/**
	 * Parses the specified command line. The specified command line is first parsed
	 * into an array, much like the operating system does for the JVM prior to calling
	 * your application's main class' main() method. If no Exception is thrown, the
	 * entire command line has been parsed successfully, and its results have been
	 * successfully instantiated.
	 * 
	 * @param cmdLine
	 *                An array of command line arguments to parse. This array is
	...
	/**
	 * Unregisters all registered AbstractParameters, allowing them to perform their
	 * cleanup.
	 */
